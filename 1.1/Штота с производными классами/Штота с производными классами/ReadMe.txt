========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Штота с производными классами
========================================================================

Это приложение Штота с производными классами создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения Штота с производными классами.


Штота с производными классами.vcxproj
...
Штота с производными классами.vcxproj.filters
...
Штота с производными классами.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Штота с производными классами.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
